...
class LoginScreen(QDialog):
    def __init__(self):
        ...
        self.back.clicked.connect(self.gobacktowelcome)


    def gobacktowelcome(self):
        welcome = WelcomeScreen()
        widget.addWidget(welcome)
        widget.setCurrentIndex(widget.currentIndex()+1) #provjeriti +1 -1
...
class FillProfileScreen(QDialog):
    ...
    def browsefiles(self):
        fname = QFileDialog.getOpenFileName(self,
                                             'Open file',
                                            'E:\Qt\SmartParking\login3new\images',
                                            'PNG Files (*.png);;Jpg Files(*.jpg)')
        self.filename = QPixmap(fname[0])
        self.image.setPixmap(self.filename)

                                         # 'Open file',
                                          #"C:\Users\User\Downloads\volfeb_3.jpeg" ,
